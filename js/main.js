...
// 文字閃爍
  ...
  function blinker(){
    if(i === 0){
      $('.blink_me').text('Energy and persistent conquer all things!').fadeIn(800).delay(2000).fadeOut(800);
      i = i + 1;
    }else{
      $('.blink_me').text('The longest journey begins with the first step!').fadeIn(800).delay(2000).fadeOut(800);
      i = i - 1;
    }
  }
...
function createTextAnimation() {
  var h1Text = document.getElementById('Nice to meet you! i\'m bo zheng').innerText; // 獲取<h1>標籤的文本
  var geometry = generateTextGeometry(h1Text, {
    size: 14,
    height: 0,
    font: 'droid sans',
    weight: 'bold',
